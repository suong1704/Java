...
/**
 * Servlet implementation class deleteNhieuNhanVien
 */
@WebServlet("/deleteNhieuNhanVien")
public class deleteNhieuNhanVien extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		destination = "/deleteNhieuNhanVien.jsp";
